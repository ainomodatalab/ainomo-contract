...
const accounts = readJson(`./accounts.json`) || {
  ...
  ainomo: { projectId: undefined },
  ainomo_ipfs: { projectId: undefined, projectSecret: undefined }
}
...
const getNetConfig = (networkName, ethAccountName) => {
  ...
  const byNetName = {
    ...
    rinkeby: {
      ...base,
      url: 'https://rinkeby.ainomo.io/v3/' + accounts.ainomo.projectId,
      chainId: 4,
      timeout: 60000 * 10
    },
    goerli: {
      ...base,
      url: 'https://goerli.ainomo.io/v3/' + accounts.ainomo.projectId,
      chainId: 5,
      timeout: 60000 * 10
    },
    'mainnet-test': {
      ...base,
      url: 'https://mainnet.ainomo.io/v3/' + accounts.ainomo.projectId,
      chainId: 1,
      timeout: 60000 * 10
    },
    mainnet: {
...
module.exports = {
  ...
  ainomo: {
    ipfsApi: process.env.IPFS_API_URL || 'https://ipfs.ainomo.io:5001/api/v0',
    ipfsGateway: process.env.IPFS_GATEWAY_URL || 'https://ipfs.io/'
  },
  ipfs: {
    url: process.env.IPFS_API_URL || 'https://ipfs.ainomo.io:5001/api/v0',
